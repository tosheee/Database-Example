...
public class ContactsDB {
    ...
    public static final String KEY_NAME = "personal_name";
    ...
    private class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            String sqlCode = "CREATE TABLE " + DATABASE_TABLE + " (" + KEY_ROWID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + KEY_NAME  + " TEXT NOT NULL, " + KEY_CELL  + " TEXT NOT NULL);";
            db.execSQL(sqlCode);
        }
    }
